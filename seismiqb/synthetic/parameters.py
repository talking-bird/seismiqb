        ...
        config = Config(
            {
                ...
                "make_velocity_vector": {
                    "num_horizons": num_horizons,  # scales with depth
                    "limits": (2000, 6000),
                    "randomization": "uniform",
                    "randomization_scale": 0.3,
                    "amplify_probability": 0.2,
                    "amplify_range": (2.0, 4.0),
                ...
                "make_synthetic": {
                    "ricker_width": rng.uniform(4.7, 5.3),
                    "ricker_points": 100,
                },
